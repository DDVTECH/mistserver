...
//  amfreply.getContentP(1)->getContentP(0)->getContentP(0)->addContent(AMFType("length",(double)59641700));
  ...
  amfreply.getContentP(1)->getContentP(0)->getContentP(0)->getContentP(2)->addContent(AMFType("arrVal"));
  amfreply.getContentP(1)->getContentP(0)->getContentP(0)->getContentP(2)->getContentP(0)->addContent(AMFType("sampletype","avc1"));
  amfreply.getContentP(1)->getContentP(0)->addContent(AMFType("arrVal"));
...
//  amfreply.getContentP(1)->getContentP(0)->getContentP(1)->addContent(AMFType("length",(double)28630000));
  ...
  amfreply.getContentP(1)->getContentP(0)->getContentP(1)->getContentP(2)->addContent(AMFType("arrVal"));
  amfreply.getContentP(1)->getContentP(0)->getContentP(1)->getContentP(2)->getContentP(0)->addContent(AMFType("sampletype","mp4a"));
